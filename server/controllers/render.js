...
module.exports = function (req, res) {
  ...
  var filePath = path.resolve(__dirname, '../../dist/src/views/pages', page, page + '.html');
  ...
  fs.readFile(filePath, (err, html) => {
    ...
    res.setHeader('Cache-Control', 'public, max-age=' + (conf.mode === 'PROD' ? conf.pageMaxAge : 0) + ', stale-while-revalidate=' + 3600);
